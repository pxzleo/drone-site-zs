...
<section class="section">
  <div class="container">
    ...
    <div class="grid grid-3">
      ...
      <article class="card news-card"><div class="card-body"><span class="news-date">2025</span><h3>星幻编队无人机适配大型室外演出</h3><p>多星多频 RTK、升级动力系统与自主网通信系统提升了外场复杂环境下的编队效率和抗干扰能力。</p></div></article>
